...
const faq = [
  ...
  {
    question: "Кому я плачу и что покупаю юридически?",
    answer: "Услугу по организации посадки дерева. Продавец — самозанятый (реквизиты указаны в оферте), посадку выполняют партнёры-исполнители. Чек приходит официально, через приложение «Мой налог»."
  }
]
